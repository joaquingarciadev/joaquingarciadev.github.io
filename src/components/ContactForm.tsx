                                ...
                                <div className="max-h-44 overflow-y-auto pr-1 flex flex-col gap-3">
                                    {inquiries.map((inq) => (
                                        ...
                                        >
                                            ...
                                            <p className="text-graphite dark:text-ash italic">
                                                "{inq.message}"
                                            </p>
                                            <span className="text-[9px] text-stone font-mono self-end mt-1">
                                                {inq.date}
                                            </span>
                                        </div>
                                    ))}
                    ...
                    <div className="lg:col-span-7">
                        <div className="bg-pure-white dark:bg-deep-charcoal/70 rounded-[28px] p-6 md:p-10 border border-ash/30 dark:border-brand-glow/20 shadow-sm dark:shadow-brand/10 relative">
                            ...
                            >
                                ...
                                {/* Error Box */}
                                {validationError && (
                                    <p className="text-xs text-rose-500 font-sans text-left mt-1">
                                        {validationError}
                                    </p>
                                )}
