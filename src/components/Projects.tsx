...
export default function Projects({
    ...
    const filteredProjects =
        activeFilter === "Todos"
            ? projectsData
            : projectsData.filter(
                  (project: Project) => project.type === activeFilter,
              );
            ...
            <div className="w-full max-w-6xl mx-auto px-6 relative">
                ...
                <div className="flex justify-between items-center mb-6 px-2">
                    <p className="font-mono text-[11px] uppercase tracking-wider text-graphite dark:text-ash">
                        {t("projects.showing")}{" "}
                        <span className="font-bold text-brand dark:text-brand-glow">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="relative aspect-[16/10] overflow-hidden bg-pure-white dark:bg-deep-charcoal border-b border-ash/20 dark:border-graphite/20">
                                            ...
                                            />
                                            {/* Category overlay */}
                                            <span className="absolute bottom-4 left-4 bg-brand/85 backdrop-blur-md text-[10px] font-mono tracking-widest text-pure-white uppercase px-2.5 py-1 rounded-full border border-brand-glow/40">
                                                {t(
                                        ...
                                        <div className="p-6 flex-grow flex flex-col justify-between relative">
                                            <a
                                                ...
                                                className="absolute -top-7 right-6 w-14 h-14 bg-brand text-pure-white hover:bg-brand-light rounded-full flex items-center justify-center border-4 border-pure-white dark:border-[#140F21] hover:scale-110 active:scale-95 transition-all z-20"
                                            ...
                                            <div>
                                                <h3
                                                    className="font-display font-bold text-xl text-off-black-ink dark:text-off-white-canvas leading-snug mb-3 pr-12 truncate"
                                                    title={project.name}
                                                >
                                                    {project.name}
                                                </h3>
